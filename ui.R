...
Audience <- "Our target audience for this project is people who stream music and care about the danceability and valence of their music. This will tend to be people in their late teens and early twenties, because they are the primary group that uses streaming services, and they care the most about how easy a song is to dance to and how it makes them feel. Even though our data is acquired from Spotify, it can be used to find trends in all streaming services, so our audience is not restricted to just Spotify users."
